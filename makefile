...
mytests: mytests.o HashMapTree.o RBTreeNode.o RBTree.o HashMap.o # Set.o - include that here and line 3
    g++ -o mytests mytests.o HashMapTree.o RBTreeNode.o HashMap.o 
    ./mytests

mytests.o: mytests.cpp HashMapTree.hpp RBTreeNode.hpp RBTree.hpp HashMap.hpp customexceptions.hpp # Set.hpp ADD THESE WHEN THEY'RE IMPLEMENTED
